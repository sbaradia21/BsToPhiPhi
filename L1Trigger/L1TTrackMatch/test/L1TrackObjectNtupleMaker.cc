...
// NAMESPACES
using namespace std;
using namespace edm;using namespace l1t;
//////////////////////////////
//                          //
//     CLASS DEFINITION     //
//                          //
...
public:
  ...
  l1tntupleemu::global_phi_t localToGlobalPhi(const TTTrack_TrackWord::phi_t& local_phi, const l1tntupleemu::global_phi_t& sector_shift) const;

  std::vector<l1tntupleemu::global_phi_t> generatePhiSliceLUT (unsigned int N){
    float sliceCentre = 0.0;
    std::vector<l1tntupleemu::global_phi_t> phiLUT;
    for (unsigned int q = 0; q <= N; q++) {
      phiLUT.push_back((l1tntupleemu::global_phi_t)(sliceCentre / l1tntupleemu::kStepPhi));
...
private:
  ...
  std::vector<l1tntupleemu::global_phi_t> phiQuadrants;
  std::vector<l1tntupleemu::global_phi_t> phiShift;
  ...
  edm::InputTag L1PosKaonTrackSelectedInputTag;                   // L1 track collection
  edm::InputTag L1PosKaonTrackSelectedEmulationInputTag;          // L1 track collection
  edm::InputTag L1NegKaonTrackSelectedInputTag;                   // L1 track collection
  edm::InputTag L1NegKaonTrackSelectedEmulationInputTag;          // L1 track collection
  ...
  //  edm::InputTag L1EmuVertexInputTag;
  ...
  edm::EDGetTokenT<L1TrackRefCollection> ttPosKaonTrackSelectedToken_;
  edm::EDGetTokenT<L1TrackRefCollection> ttPosKaonTrackSelectedEmulationToken_;

  edm::EDGetTokenT<L1TrackRefCollection> ttNegKaonTrackSelectedToken_;
  edm::EDGetTokenT<L1TrackRefCollection> ttNegKaonTrackSelectedEmulationToken_;
  ...
  std::vector<float>* m_trk_charge_emu;
  ...
  std::vector<int>* m_poskaontrk_selected_index;
  std::vector<int>* m_poskaontrk_selected_emulation_index;

  std::vector<int>* m_negkaontrk_selected_index;
  std::vector<int>* m_negkaontrk_selected_emulation_index;
  ...
  std::vector<float>* m_trkphicands_mass;
  std::vector<float>* m_trkphicands_phi;
  std::vector<float>* m_trkphicands_eta;
  std::vector<float>* m_trkphicands_pt;

  /*  std::vector<float>* m_trkphicandstrk1_phi;
  std::vector<float>* m_trkphicandstrk1_eta;
  std::vector<float>* m_trkphicandstrk1_pt;

  std::vector<float>* m_trkphicandstrk2_phi;
  std::vector<float>* m_trkphicandstrk2_eta;
  std::vector<float>* m_trkphicandstrk2_pt;
  */
  std::vector<float>* m_trkphicandsExt_mass;
  std::vector<float>* m_trkphicandsExt_phi;
  std::vector<float>* m_trkphicandsExt_eta;
  std::vector<float>* m_trkphicandsExt_pt;

  /* std::vector<float>* m_trkphicandstrk1Ext_phi;
  std::vector<float>* m_trkphicandstrk1Ext_eta;
  std::vector<float>* m_trkphicandstrk1Ext_pt;

  std::vector<float>* m_trkphicandstrk2Ext_phi;
  std::vector<float>* m_trkphicandstrk2Ext_eta;
  std::vector<float>* m_trkphicandstrk2Ext_pt;*/

  std::vector<float>* m_trkbscands_mass;
  std::vector<float>* m_trkbscands_phi;
  std::vector<float>* m_trkbscands_eta;
  std::vector<float>* m_trkbscands_pt;

  std::vector<float>* m_trkbscandsExt_mass;
  std::vector<float>* m_trkbscandsExt_phi;
  std::vector<float>* m_trkbscandsExt_eta;
  std::vector<float>* m_trkbscandsExt_pt;

  std::vector<float>* m_trkphicandsemulation_mass;
  std::vector<float>* m_trkphicandsemulation_phi;
  std::vector<float>* m_trkphicandsemulation_eta;
  std::vector<float>* m_trkphicandsemulation_pt;

  std::vector<float>* m_trkphicandsemulationExt_mass;
  std::vector<float>* m_trkphicandsemulationExt_phi;
  std::vector<float>* m_trkphicandsemulationExt_eta;
  std::vector<float>* m_trkphicandsemulationExt_pt;

  std::vector<float>* m_trkbscandsemulation_mass;
  std::vector<float>* m_trkbscandsemulation_phi;
  std::vector<float>* m_trkbscandsemulation_eta;
  std::vector<float>* m_trkbscandsemulation_pt;

  std::vector<float>* m_trkbscandsemulationExt_mass;
  std::vector<float>* m_trkbscandsemulationExt_phi;
  std::vector<float>* m_trkbscandsemulationExt_eta;
  std::vector<float>* m_trkbscandsemulationExt_pt;
...
L1TrackObjectNtupleMaker::L1TrackObjectNtupleMaker(edm::ParameterSet const& iConfig) : config(iConfig) {
  ...
  //  L1VertexInputTag = iConfig.getParameter<InputTag>("L1VertexInputTag");
  //  L1EmuVertexInputTag = iConfig.getParameter<InputTag>("L1EmuVertexInputTag");
  ...
  if (Displaced == "Prompt" || Displaced == "Both") {
    ...
    L1PosKaonTrackSelectedInputTag = iConfig.getParameter<edm::InputTag>("L1PosKaonTrackSelectedInputTag");
    L1PosKaonTrackSelectedEmulationInputTag = iConfig.getParameter<edm::InputTag>("L1PosKaonTrackSelectedEmulationInputTag");

    L1NegKaonTrackSelectedInputTag = iConfig.getParameter<edm::InputTag>("L1NegKaonTrackSelectedInputTag");
    L1NegKaonTrackSelectedEmulationInputTag = iConfig.getParameter<edm::InputTag>("L1NegKaonTrackSelectedEmulationInputTag");
    ...
    ttPosKaonTrackSelectedToken_ = consumes<L1TrackRefCollection>(L1PosKaonTrackSelectedInputTag);
    ttPosKaonTrackSelectedEmulationToken_ = consumes<L1TrackRefCollection>(L1PosKaonTrackSelectedEmulationInputTag);

    ttNegKaonTrackSelectedToken_ = consumes<L1TrackRefCollection>(L1NegKaonTrackSelectedInputTag);
    ttNegKaonTrackSelectedEmulationToken_ = consumes<L1TrackRefCollection>(L1NegKaonTrackSelectedEmulationInputTag);
  ...
  //  L1VertexToken_ = consumes<l1t::Vertex>(L1VertexInputTag);
  //L1VertexEmuToken_ = consumes<l1t::VertexWord>(L1EmuVertexInputTag);
  L1VertexToken_ = consumes<l1t::VertexCollection>(RecoVertexInputTag);
  L1VertexEmuToken_ = consumes<l1t::VertexWordCollection>(RecoVertexEmuInputTag);
  ...
  phiQuadrants = L1TrackObjectNtupleMaker::generatePhiSliceLUT(l1tntupleemu::kNQuadrants);
  phiShift = L1TrackObjectNtupleMaker::generatePhiSliceLUT(l1tntupleemu::kNSector);
...
l1tntupleemu::global_phi_t L1TrackObjectNtupleMaker::localToGlobalPhi(const TTTrack_TrackWord::phi_t& local_phi, const l1tntupleemu::global_phi_t& sector_shift) const {
  int PhiMin = 0;
  int PhiMax = phiQuadrants.back();

  //  int PhiMax = L1PhiMesonSelectionEmulationProducer::generatePhiSliceLUT(l1tntupleemu::kNQuadrants).back();                                                        
  int phiMultiplier = TTTrack_TrackWord::TrackBitWidths::kPhiSize - l1tntupleemu::kInternalPhiWidth;

  int tempPhi = floor(l1tntupleemu::undigitizeSignedValue(local_phi, TTTrack_TrackWord::TrackBitWidths::kPhiSize) / pow(2, phiMultiplier)) + sector_shift;
  ...
  l1tntupleemu::global_phi_t globalPhi = l1tntupleemu::global_phi_t(tempPhi);
  return globalPhi;
}
...
void L1TrackObjectNtupleMaker::beginJob() {
  ...
  m_trk_charge_emu = new std::vector<float>;
  ...
  m_poskaontrk_selected_index = new std::vector<int>;
  m_poskaontrk_selected_emulation_index = new std::vector<int>;

  m_negkaontrk_selected_index = new std::vector<int>;
  m_negkaontrk_selected_emulation_index = new std::vector<int>;
  ...
  m_trkphicands_eta = new std::vector<float>;
  //m_trkphicand_vz = new std::vector<float>;
  m_trkphicands_phi = new std::vector<float>;
  m_trkphicands_mass = new std::vector<float>;
  m_trkphicands_pt = new std::vector<float>;

  /*  m_trkphicandstrk1_phi = new std::vector<float>;
  m_trkphicandstrk1_mass = new std::vector<float>;
  m_trkphicandstrk1_pt = new std::vector<float>;

  m_trkphicandstrk2_phi = new std::vector<float>;
  m_trkphicandstrk2_mass = new std::vector<float>;
  m_trkphicandstrk2_pt = new std::vector<float>;*/

  m_trkphicandsExt_eta = new std::vector<float>;
  //m_trkphicand_vz = new std::vector<float>;
  m_trkphicandsExt_phi = new std::vector<float>;
  m_trkphicandsExt_mass = new std::vector<float>;
  m_trkphicandsExt_pt = new std::vector<float>;
 
  /*  m_trkphicandstrk1Ext_phi = new std::vector<float>;
  m_trkphicandstrk1Ext_mass = new std::vector<float>;
  m_trkphicandstrk1Ext_pt = new std::vector<float>;

  m_trkphicandstrk2Ext_phi = new std::vector<float>;
  m_trkphicandstrk2Ext_mass = new std::vector<float>;
  m_trkphicandstrk2Ext_pt = new std::vector<float>;*/
 
  m_trkbscands_eta = new std::vector<float>;
  //m_trkbscand_vz = new std::vector<float>;
  m_trkbscands_phi = new std::vector<float>;
  m_trkbscands_mass = new std::vector<float>;
  m_trkbscands_pt = new std::vector<float>;

  m_trkbscandsExt_eta = new std::vector<float>;
  //m_trkbscand_vz = new std::vector<float>;
  m_trkbscandsExt_phi = new std::vector<float>;
  m_trkbscandsExt_mass = new std::vector<float>;
  m_trkbscandsExt_pt = new std::vector<float>;

  m_trkphicandsemulation_eta = new std::vector<float>;
  //m_trkphicand_vz = new std::vector<float>;
  m_trkphicandsemulation_phi = new std::vector<float>;
  m_trkphicandsemulation_mass = new std::vector<float>;
  m_trkphicandsemulation_pt = new std::vector<float>;

  m_trkphicandsemulationExt_eta = new std::vector<float>;
  //m_trkphicand_vz = new std::vector<float>;
  m_trkphicandsemulationExt_phi = new std::vector<float>;
  m_trkphicandsemulationExt_mass = new std::vector<float>;
  m_trkphicandsemulationExt_pt = new std::vector<float>;
 
  m_trkbscandsemulation_eta = new std::vector<float>;
  //m_trkbscand_vz = new std::vector<float>;
  m_trkbscandsemulation_phi = new std::vector<float>;
  m_trkbscandsemulation_mass = new std::vector<float>;
  m_trkbscandsemulation_pt = new std::vector<float>;

  m_trkbscandsemulationExt_eta = new std::vector<float>;
  //m_trkbscand_vz = new std::vector<float>;
  m_trkbscandsemulationExt_phi = new std::vector<float>;
  m_trkbscandsemulationExt_mass = new std::vector<float>;
  m_trkbscandsemulationExt_pt = new std::vector<float>;

  phimassH_     = fs->make<TH1D>("phimass",    "Phi Mass",15, 1.0, 1.03);
  phimassEmuH_  = fs->make<TH1D>("phimassEmu", "Emulated Phi Mass", 15, 1.0, 1.03);
  bsmassH_     = fs->make<TH1D>("bsmass",    "Bs Mass", 102, 5.0, 5.8);
  bsmassEmuH_  = fs->make<TH1D>("bsmassEmu", "Emulated Bs Mass", 102, 5.0, 5.8);
  ...
  if (SaveAllTracks && (Displaced == "Prompt" || Displaced == "Both")) {
    ...
    eventTree->Branch("trk_charge_emu", &m_trk_charge_emu);
    ...
    eventTree->Branch("trk_poskaon_gtt_selected_index", &m_poskaontrk_selected_index);
    eventTree->Branch("trk_poskaon_gtt_selected_emulation_index", &m_poskaontrk_selected_emulation_index);

    eventTree->Branch("trk_negkaon_gtt_selected_index", &m_negkaontrk_selected_index);
    eventTree->Branch("trk_negkaon_gtt_selected_emulation_index", &m_negkaontrk_selected_emulation_index);
  }
  ...
  if (SaveTrackPhiCands) {
    if (Displaced == "Prompt" || Displaced == "Both") {
      eventTree->Branch("trkphicands_eta", &m_trkphicands_eta);
      //eventTree->Branch("trkphicands_vz", &m_trkphicands_vz);
      eventTree->Branch("trkphicands_mass", &m_trkphicands_mass);
      eventTree->Branch("trkphicands_pt", &m_trkphicands_pt);
      eventTree->Branch("trkphicands_phi", &m_trkphicands_phi);
      
      /*      eventTree->Branch("trkphicandstrk1_eta", &m_trkphicandstrk1_eta);
      eventTree->Branch("trkphicandstrk1_pt", &m_trkphicandstrk1_pt);
      eventTree->Branch("trkphicandstrk1_phi", &m_trkphicandstrk1_phi);

      eventTree->Branch("trkphicandstrk2_eta", &m_trkphicandstrk2_eta);
      eventTree->Branch("trkphicandstrk2_pt", &m_trkphicandstrk2_pt);
      eventTree->Branch("trkphicandstrk2_phi", &m_trkphicandstrk1_phi);*/

      eventTree->Branch("trkphicandsemulation_eta", &m_trkphicandsemulation_eta);
      //eventTree->Branch("trkphicandsemulation_vz", &m_trkphicandsemulation_vz);
      eventTree->Branch("trkphicandsemulation_mass", &m_trkphicandsemulation_mass);
      eventTree->Branch("trkphicandsemulation_pt", &m_trkphicandsemulation_pt);
      eventTree->Branch("trkphicandsemulation_phi", &m_trkphicandsemulation_phi);
    }
    if (Displaced == "Displaced" || Displaced == "Both") {
      eventTree->Branch("trkphicandsExt_eta", &m_trkphicandsExt_eta);
      //eventTree->Branch("trkphicandsExt_vz", &m_trkphicandsExt_vz);
      eventTree->Branch("trkphicandsExt_mass", &m_trkphicandsExt_mass);
      eventTree->Branch("trkphicandsExt_pt", &m_trkphicandsExt_pt);
      eventTree->Branch("trkphicandsExt_phi", &m_trkphicandsExt_phi);

      /*      eventTree->Branch("trkphicandstrk1Ext_eta", &m_trkphicandstrk1Ext_eta);
      eventTree->Branch("trkphicandstrk1Ext_pt", &m_trkphicandstrk1Ext_pt);
      eventTree->Branch("trkphicandstrk1Ext_phi", &m_trkphicandstrk1Ext_phi);
      
      eventTree->Branch("trkphicandstrk2Ext_eta", &m_trkphicandstrk2Ext_eta);
      eventTree->Branch("trkphicandstrk2Ext_pt", &m_trkphicandstrk2Ext_pt);
      eventTree->Branch("trkphicandstrk2Ext_phi", &m_trkphicandstrk2Ext_phi);*/
	    
      eventTree->Branch("trkphicandsemulationExt_eta", &m_trkphicandsemulationExt_eta);
      //eventTree->Branch("trkphicandsemulation_vz", &m_trkphicandsemulationExt_vz);
      eventTree->Branch("trkphicandsemulationExt_mass", &m_trkphicandsemulationExt_mass);
      eventTree->Branch("trkphicandsemulationExt_pt", &m_trkphicandsemulationExt_pt);
      eventTree->Branch("trkphicandsemulationExt_phi", &m_trkphicandsemulationExt_phi);
    }
  }

  if (SaveTrackBsCands) {
    if (Displaced == "Prompt" || Displaced == "Both") {
      eventTree->Branch("trkbscands_eta", &m_trkbscands_eta);
      //eventTree->Branch("trkbscands_vz", &m_trkbscands_vz);
      eventTree->Branch("trkbscands_mass", &m_trkbscands_mass);
      eventTree->Branch("trkbscands_pt", &m_trkbscands_pt);
      eventTree->Branch("trkbscands_phi", &m_trkbscands_phi);

      eventTree->Branch("trkbscandsemulation_eta", &m_trkbscandsemulation_eta);
      //eventTree->Branch("trkbscandsemulation_vz", &m_trkbscandsemulation_vz);
      eventTree->Branch("trkbscandsemulation_mass", &m_trkbscandsemulation_mass);
      eventTree->Branch("trkbscandsemulation_pt", &m_trkbscandsemulation_pt);
      eventTree->Branch("trkbscandsemulation_phi", &m_trkbscandsemulation_phi);      
    }
    if (Displaced == "Displaced" || Displaced == "Both") {
      eventTree->Branch("trkbscandsExt_eta", &m_trkbscandsExt_eta);
      //eventTree->Branch("trkbscandsExt_vz", &m_trkbscandsExt_vz);
      eventTree->Branch("trkbscandsExt_mass", &m_trkbscandsExt_mass);
      eventTree->Branch("trkbscandsExt_pt", &m_trkbscandsExt_pt);
      eventTree->Branch("trkbscandsExt_phi", &m_trkbscandsExt_phi);

      eventTree->Branch("trkbscandsemulationExt_eta", &m_trkbscandsemulationExt_eta);
      //eventTree->Branch("trkbscandsemulationExt_vz", &m_trkbscandsemulationExt_vz);
      eventTree->Branch("trkbscandsemulationExt_mass", &m_trkbscandsemulationExt_mass);
      eventTree->Branch("trkbscandsemulationExt_pt", &m_trkbscandsemulationExt_pt);
      eventTree->Branch("trkbscandsemulationExt_phi", &m_trkbscandsemulationExt_phi);
    }
  }
}
...
void L1TrackObjectNtupleMaker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if (SaveAllTracks && (Displaced == "Prompt" || Displaced == "Both")) {
    ...
    m_poskaontrk_selected_index->clear();
    m_poskaontrk_selected_emulation_index->clear();

    m_negkaontrk_selected_index->clear();
    m_negkaontrk_selected_emulation_index->clear();
  ...
  if (SaveTrackPhiCands) {
    if (Displaced == "Prompt" || Displaced == "Both") {
      m_trkphicands_eta->clear();
      m_trkphicands_pt->clear();
      //m_trkphicands_vz->clear();
      m_trkphicands_phi->clear();
      m_trkphicands_mass->clear();

      m_trkphicandsemulation_eta->clear();
      m_trkphicandsemulation_pt->clear();
      //m_trkphicandsemulation_vz->clear();
      m_trkphicandsemulation_phi->clear();
      m_trkphicandsemulation_mass->clear();
    }
    if (Displaced == "Displaced" || Displaced == "Both") {
      m_trkphicandsExt_eta->clear();
      m_trkphicandsExt_pt->clear();
      //m_trkphicandsExt_vz->clear();
      m_trkphicandsExt_phi->clear();
      m_trkphicandsExt_mass->clear();

      m_trkphicandsemulationExt_eta->clear();
      m_trkphicandsemulationExt_pt->clear();
      //m_trkphicandsemulationExt_vz->clear();
      m_trkphicandsemulationExt_phi->clear();
      m_trkphicandsemulationExt_mass->clear();
    }
  }

  if (SaveTrackBsCands) {
    if (Displaced == "Prompt" || Displaced == "Both") {
      m_trkbscands_eta->clear();
      m_trkbscands_pt->clear();
      //m_trkbscands_vz->clear();
      m_trkbscands_phi->clear();
      m_trkbscands_mass->clear();

      m_trkbscandsemulation_eta->clear();
      m_trkbscandsemulation_pt->clear();
      //m_trkbscandsemulation_vz->clear();
      m_trkbscandsemulation_phi->clear();
      m_trkbscandsemulation_mass->clear();
    }
    if (Displaced == "Prompt" || Displaced == "Both") {
      m_trkbscands_eta->clear();
      m_trkbscands_pt->clear();
  ...
  edm::Handle<l1t::VertexWordCollection> L1VertexEmuHandle;
  iEvent.getByToken(L1VertexEmuToken_, L1VertexEmuHandle);
  ...
  edm::Handle<L1TrackRefCollection> TTPosKaonTrackSelectedHandle;
  edm::Handle<L1TrackRefCollection> TTPosKaonTrackSelectedEmulationHandle;

  edm::Handle<L1TrackRefCollection> TTNegKaonTrackSelectedHandle;
  edm::Handle<L1TrackRefCollection> TTNegKaonTrackSelectedEmulationHandle;
  ...
  if (Displaced == "Prompt" || Displaced == "Both") {
    ...
    iEvent.getByToken(ttPosKaonTrackSelectedToken_, TTPosKaonTrackSelectedHandle);
    iEvent.getByToken(ttPosKaonTrackSelectedEmulationToken_, TTPosKaonTrackSelectedEmulationHandle);

    iEvent.getByToken(ttNegKaonTrackSelectedToken_, TTNegKaonTrackSelectedHandle);
    iEvent.getByToken(ttNegKaonTrackSelectedEmulationToken_, TTNegKaonTrackSelectedEmulationHandle);
  ...
  if (SaveAllTracks && (Displaced == "Prompt" || Displaced == "Both")) {
    ...
    for (iterL1Track = TTTrackHandle->begin(); iterL1Track != TTTrackHandle->end(); iterL1Track++) {
      ...
      int tmp_trk_charge = std::signbit(iterL1Track->rInv());
      //std::cout << "Trk pt : " << tmp_trk_pt << "\tTrk eta : " << tmp_trk_eta << "\tTrk Phi : " << tmp_trk_phi <<  "\tTrk z0 : " << tmp_trk_z0 << std::endl;
      ...
      ap_uint<TrackBitWidths::kPtSize> ptEmulationBits = l1track_ref->getTrackWord()(
      ...
      TTTrack_TrackWord::tanl_t etaEmulationBits = l1track_ref->getTanlWord();
      ...
      double tmp_trk_localphi_emu = l1track_ref->getPhi();
      l1tntupleemu::global_phi_t tmp_trk_phi_emuPos = L1TrackObjectNtupleMaker::localToGlobalPhi(l1track_ref->getPhiWord(), phiShift[l1track_ref->phiSector()]);
      double tmp_trk_phi_emu = tmp_trk_phi_emuPos*l1tntupleemu::kStepPhi ;

      //      double tmp_trk_phi_emu = l1track_ref->getPhi();

      double tmp_trk_z0_emu = l1track_ref->getZ0();

      //      std::cout << "Trk pt emu : " << tmp_trk_pt_emu << "\tTrk eta emu : " << tmp_trk_eta_emu << "\tTrk Phi emu : " << tmp_trk_phi_emu <<  "\tTrk z0 emu : " << tmp_trk_z0_emu << std::endl;
      ...
      m_poskaontrk_selected_index->push_back(getSelectedTrackIndex(l1track_ref, TTPosKaonTrackSelectedHandle));
      m_poskaontrk_selected_emulation_index->push_back(getSelectedTrackIndex(l1track_ref, TTPosKaonTrackSelectedEmulationHandle));

      m_negkaontrk_selected_index->push_back(getSelectedTrackIndex(l1track_ref, TTNegKaonTrackSelectedHandle));
      m_negkaontrk_selected_emulation_index->push_back(getSelectedTrackIndex(l1track_ref, TTNegKaonTrackSelectedEmulationHandle));
    }  //end track loop
  ...
  if (L1VertexHandle.isValid()) {
    ...
    edm::LogWarning("DataNotFound") << "\nWarning: L1VertexHandle not found" << std::endl;
  }
  if (L1VertexEmuHandle.isValid()) {
    for (vtxEmuIter = L1VertexEmuHandle->begin(); vtxEmuIter != L1VertexEmuHandle->end();
         ++vtxEmuIter) {
      m_pv_L1reco_emu->push_back(vtxEmuIter->z0());
    }
  } else
  edm::LogWarning("DataNotFound") << "\nWarning: L1VertexEmuHandle not found" << std::endl;
  ...
  if (SaveTrackPhiCands) {
	...
	if (0) cout << "Phi Candidate: ("
		    ...
		    << phicandsIter->mass()
		    << ")" << endl;
        m_trkphicands_phi->push_back(phicandsIter->phi());
        ...
        phimassH_->Fill(phicandsIter->mass());
      }
    }
    if (TrackPhiCandsHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both")) {
      for (phicandsIter = TrackPhiCandsHandle->begin(); phicandsIter != TrackPhiCandsHandle->end(); ++phicandsIter) {
        m_trkphicandsExt_phi->push_back(phicandsIter->phi());
	...
	if (0) cout << "Emu Phi Candidate: ("
		    ...
		    << ")" << endl;
        m_trkphicandsemulation_phi->push_back(phicandsemulationIter->glbphi());
        ...
        phimassEmuH_->Fill(phicandsemulationIter->mass());
      }
    }
    if (TrackPhiCandsEmulationHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both")) {
      for (phicandsemulationIter = TrackPhiCandsEmulationHandle->begin(); phicandsemulationIter != TrackPhiCandsEmulationHandle->end(); ++phicandsemulationIter) {
        m_trkphicandsemulationExt_phi->push_back(phicandsemulationIter->glbphi());
  ...
  if (SaveTrackBsCands) {
    if (!TrackBsCandsHandle.isValid() && (Displaced == "Prompt" || Displaced == "Both"))
      edm::LogWarning("DataNotFound") << "\nWarning: TrackBsCandsHandle not found" << std::endl;
    if (!TrackBsCandsHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both"))
      edm::LogWarning("DataNotFound") << "\nWarning: TrackBsCandsHandle not found" << std::endl;
    if (TrackBsCandsHandle.isValid() && (Displaced == "Prompt" || Displaced == "Both")) {
	...
	//SB Added
        ...
        m_trkbscands_phi->push_back(bscandsIter->phi());
        m_trkbscands_eta->push_back(bscandsIter->eta());
        m_trkbscands_pt->push_back(bscandsIter->pt());
        m_trkbscands_mass->push_back(bscandsIter->mass());
	bsmassH_->Fill(bscandsIter->mass());
      }
    }
    if (TrackBsCandsHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both")) {
      for (bscandsIter = TrackBsCandsHandle->begin(); bscandsIter != TrackBsCandsHandle->end(); ++bscandsIter) {
        m_trkbscandsExt_phi->push_back(bscandsIter->phi());
        m_trkbscandsExt_eta->push_back(bscandsIter->eta());
        m_trkbscandsExt_pt->push_back(bscandsIter->pt());
        m_trkbscandsExt_mass->push_back(bscandsIter->mass());
      }
    }

    if (!TrackBsCandsEmulationHandle.isValid() && (Displaced == "Prompt" || Displaced == "Both"))
      edm::LogWarning("DataNotFound") << "\nWarning: TrackBsCandsEmulationHandle not found" << std::endl;
    if (!TrackBsCandsEmulationHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both"))
      edm::LogWarning("DataNotFound") << "\nWarning: TrackBsCandsEmulationHandle not found" << std::endl;
    if (TrackBsCandsEmulationHandle.isValid() && (Displaced == "Prompt" || Displaced == "Both")) {
	...
	//SB Added
        ...
        m_trkbscandsemulation_phi->push_back(bscandsemulationIter->glbphi());
        m_trkbscandsemulation_eta->push_back(bscandsemulationIter->glbeta());
        m_trkbscandsemulation_pt->push_back(bscandsemulationIter->pt());
        m_trkbscandsemulation_mass->push_back(bscandsemulationIter->mass());
	bsmassEmuH_->Fill(bscandsemulationIter->mass());
      }
    }
    if (TrackBsCandsEmulationHandle.isValid() && (Displaced == "Displaced" || Displaced == "Both")) {
      for (bscandsemulationIter = TrackBsCandsEmulationHandle->begin(); bscandsemulationIter != TrackBsCandsEmulationHandle->end(); ++bscandsemulationIter) {
        m_trkbscandsemulationExt_phi->push_back(bscandsemulationIter->glbphi());
        m_trkbscandsemulationExt_eta->push_back(bscandsemulationIter->glbeta());
        m_trkbscandsemulationExt_pt->push_back(bscandsemulationIter->pt());
        m_trkbscandsemulationExt_mass->push_back(bscandsemulationIter->mass());
      }
    }
  } // end track bscands
